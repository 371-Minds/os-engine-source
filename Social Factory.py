...
\f0\fs24 \cf0 \{\
  ...
  "name": "
\f1  
\f0 Automated  Social Media Content Factory for  X + Facebook + Instagram + LinkedIn",\
  "tags": [],\
  "nodes": [\
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# 
\f1 \uc0\u55358 \u56785 \u8205 \u55358 \u56753 
\f0  User Input for Social Media Posts \\n
\f1 \uc0\u55357 \u56481 
\f0  Unpin default data to get started"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# 
\f1 \uc0\u55357 \u57056 \u65039 
\f0  Social Media Content Factory\\n- LinkedIn\\n- Instagram\\n- Facebook\\n- X\\n- TikTok\\n- Threads\\n- YouTube Shorts\\n"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# 
\f1 \uc0\u55357 \u56397 
\f0  Approve Content Before Proceeding"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# 
\f1 \uc0\u9993 \u65039 
\f0  Prepare & Format Approval Email"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
...
\f0 FOR APPROVAL
\f1 \uc0\u55357 \u56613 
\f0 \{\{ $('Social Media Content Factory').item.json.output.name \}\} - \{\{ $('Social Media Content Factory').item.json.output.description \}\}",\
    ...
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# Step 
\f1 4\uc0\u65039 \u8419 
\f0 : Send Final Results of Social Media Factory"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
...
\f0 : Create Social Media Written Content\\nNote:  \\nYou could use the output of step 1 to create your written content and manually post if required.  \\nYou so not have to implement step 2."\
    ...
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# Step 
\f1 2\uc0\u65039 \u8419 
\f0 : Create Image or Upload Image for Social Post"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
      ...
      "parameters": \{\
        ...
        "content": "# Step 
\f1 3\uc0\u65039 \u8419 
\f0 : Publish Final Social Media Posts"\
      \},\
      "typeVersion": 1\
    \},\
    \{\
